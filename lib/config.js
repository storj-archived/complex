...
function RenterConfig(options) {
  ...
  this._.networkPrivateExtendedKey = options.networkPrivateExtendedKey || null;
  this._.networkIndex = options.networkIndex || null;
  this._.networkPrivateKey = options.networkPrivateKey || null;
...
function readPrivateKey(config) {
  if (config._.networkPrivateExtendedKey) {
