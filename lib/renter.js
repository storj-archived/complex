...
Renter.prototype._publishContract = function(contacts, contract, callback) {
  // TODO
  // send publish message with zero ttl to all contacts
  // update contacts with `lastPublishSent`
  // record available offer in mirrors collection
  // respond with first offer in callback
};
