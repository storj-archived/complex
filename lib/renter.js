...
Renter.prototype._initPrivateKey = function(options) {
  ...
  if (options.networkPrivateExtendedKey) {
    ...
    this.hdKeyIndex = options.networkIndex;
    ...
    assert(typeof options.networkPrivateKey === 'string');
    this.keyPair = storj.KeyPair(options.networkPrivateKey);
  }
...
Renter.prototype._signStorageContract = function(contract) {
  if (this.hdKey) {
    ...
    contract.set('renter_hd_index', this.hdKeyIndex);
  }
